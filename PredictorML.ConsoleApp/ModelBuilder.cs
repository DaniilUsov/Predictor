...
namespace PredictorML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"E:\Download\Типо база данных.csv";
        private static string MODEL_FILEPATH = @"C:\Users\danii.LAPTOP-VHVGL7JM\AppData\Local\Temp\MLVSTools\PredictorML\PredictorML.Model\MLModel.zip";
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.Regression.CrossValidate(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "crime_count");
